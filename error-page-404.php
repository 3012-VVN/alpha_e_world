...
<head>
    ...
    <title>Avivon - Pure Business Consulting & Finance HTML5 Template</title>
...
<body>
    ...
    <div class="offcanvas-menu">
        ...
        <ul class="off__menu">
            ...
            <li><a href="service1.html">services 01</a></li>
            <li><a href="service2.html">services 02</a></li>
            <li><a href="single-service.html">single service</a></li>
            <li class="menu__title-only">pages <i class="fas fa-angle-down"></i></li>
            <li><a href="about-us1.html">about us 01</a></li>
            <li><a href="about-us2.html">about us 02</a></li>
            <li><a href="our-mission.html">our mission</a></li>
            <li><a href="our-history.html">our history</a></li>
            <li><a href="our-partnership.html">partnership</a></li>
            <li><a href="error-page-404.html">error 404 page</a></li>
    ...
    <!-- ================================
           START MENU AREA
================================= -->
    <section class="menu-area error-menu theme-afr" style="    background-color: #222232;">
        <div class="top-menu-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="menu-full-width clearfix">
                            <div class="logo-box theme-afr">
                                <div class="site-open">
                                ...
                                <div class="logo">
                                    <a href="index.html" title="Avivon"><img src="assets/logo2.png"
                                            style="max-height:43px;" alt="logo"></a>
                                </div><!-- end logo -->
                            </div><!-- end logo-box -->
                            <div class="main-menu">
...
=================================-->
    <section class="error-area">
        <div class="error-fluid">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="error-box">
                            <img src="images/404.png" alt="error image" class="error__img">
                            <p class="error__desc">sorry, we couldn't find the page you're looking for.</p>
                            <a href="index.html" class="back__top">
                                back to home <span class="fontello icon-angle-double-right"></span>
                            </a>
                        </div><!-- end error-box-->
                    </div><!-- end col-md-12 -->
                </div><!-- end row -->
...
=================================-->
    ...
    <!--================================
        START FOOTER AREA
=================================-->
    <section class="footer-area error-footer theme-bg-dark">
        <div class="footer-fluid">
            <div class="container">
                <div class="row copyright-shared error-copyright theme-afr">
                    <div class="col-md-8">
                        <p class="copy__desc">&copy;copyright 2019 by <a href="mailto:support@alphaeworld.com">Alpha
                                Exchange World</a></p>
                    </div><!-- end col-md-8 -->
