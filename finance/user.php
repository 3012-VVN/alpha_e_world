...
?>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="card card-user" id="profile">
              <div class="card-header">
              <h5 class="card-title sbcc"><span style="color: #66615B;font-weight: bold;">User Profile Details</span> | <a href="#Bank" class="account" >Account Information</a> </h5> 
              </div>
              <div class="card-body">
              <?php if ($ss !=''){ ?>
              ...
              <?php }?>
                  ...
                  <div class="row">
                    ...
                    <input  type="hidden" name='state' value='edit'>
                      <button type="submit" class="btn btn-primary btn-round"><?php if ($ss==''){echo 'Edit Profile';}else {echo 'Update Profile';}?></button>
                      <?php if ($ss ==''){ ?>
                      </form>
                    <?php }?>
                    </div>
            ...
            <div class="card card-user" id="account" style="display:none">
              <div class="card-header">
                <h5 class="card-title sbcc" > <a href="" class="profile">User Profile Details</a> | <span style="color: #66615B;font-weight: bold;">Account Information</span> </h5> 
              </div>
              <div class="card-body">
              <?php if ($ss2 !=''){ ?>
              <form method="POST" action="/UserAccountUpdate" enctype="multipart/form-data">
              <?php }?>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
    ...
    background-color: white;'>
                                  ...
                                  <option value='1' <?php if ($UserBankInfo['cardtype']==1){echo 'selected';}; ?> >TIN</option>
                                  <option value='2' <?php if ($UserBankInfo['cardtype']==2){echo 'selected';}; ?>>PAN</option>
                                  <option value='4' <?php if ($UserBankInfo['cardtype']==4){echo 'selected';}; ?>>Other</option>
                                  </select>
                        <input  type="text" class="form-control" <?php echo $ss3;?> placeholder="ID Number" name='pancard' value="<?php echo $UserBankInfo['pancard']; ?>">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
    ...
    background-color: white;'>
                  ...
                  <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>IFSC Code(if applicable)</label>
                  ...
                  <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label style="    color: #5ccbcf;
    font-size: 12px;
    font-weight: bold;">Click Here To Attach All Required Documents</label>
                        <input required type="file" accept="image/x-png,image/gif,image/jpeg" multiple  class="form-control" <?php echo $ss3;?> name='files[]'>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <form method="GET" action="">
                    <?php }?>
                    <input  type="hidden" name='astate' value='edit'>
                      <button type="submit" class="btn btn-primary btn-round"><?php if ($ss2==''){echo 'Edit Account Information';}else {echo 'Update Account Information';}?></button>
                      <?php if ($ss2 ==''){ ?>
                      </form>
                    <?php }?>
                    </div>
