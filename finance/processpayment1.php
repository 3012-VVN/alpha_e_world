...
<?php
        ...
        if ($_SESSION['payid'] == 2) {
            ...
            header('Location: https://www.alphaeworld.com/Dashboard?payment=DECLINED');
        }
        ...
        if ($_SESSION['payid'] == 2) {
            ...
            header('Location: https://www.alphaeworld.com/Dashboard?payment=ERROR&ss=' . $data->error_message);
        }
        ...
        if ($_SESSION['payid'] == 2) {
            ...
            header('Location: https://www.alphaeworld.com/Dashboard?payment=SUCCESS&trans_id=' . $data->trans_id);
        }
    }

    echo $data->result . " - " . $_SESSION['payid'];
}