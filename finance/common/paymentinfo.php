            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div id="pg">
                            <form method="POST" action="/ProcessPayment1" enctype="multipart/form-data">
                                <div class="input-fields">
                                    <div class="column-1">
                                        ...
                                        <div class="small-inputs">
                                            <div>
                                                ...
                                                <input type="text" id="date" name="card_exp" placeholder="MM / YYYY"
                                                    maxlength="7">
                                            </div>
                                    ...
                                    <div class="column-2">
                                        ...
                                        <span class="info">* CVV or CVC is the card security code, unique three digits
                        ...
                        <div id="banktransfer">
                            <form method="POST" action="/SubmitPaymentDetail" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card-header">
                                            ...
                                            <p>Bank Name: <span style="font-weight: bold;">SOCIETE GENERALE BANKA SRBIJA
                                                    AD</span><br>
                                                Account no. <span
                                                    style="font-weight: bold;">275002022316677422</span><br>
                                ...
                                <div class="row">
                                    <div class="col-md-5 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Transaction Deatils"
                                                name='tdetails'>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 pr-1">
                                        <label>OR </label>
                                        <label style="    color: black;">Upload Bank Recipt / Transaction
                                            Screenshot</label>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="Transaction Deatils"
                                                name='recipt'>
                                        </div>
                                    </div>
                                </div>
