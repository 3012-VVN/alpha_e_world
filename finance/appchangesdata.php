...
while ($row = mysqli_fetch_assoc($checkrst)) {
    ...
    ?>
                <tr>
                    ...
                    <td><a href="javascript:showMe('<?php echo $row['ID']; ?>')"><img src="/img/document_search.png"
                                style="width: 20px;"></a></td>
                    <td><a href="javascript:showMe1('<?php echo $row['ID']; ?>')"
                            id='ab<?php echo $row['ID']; ?>'>Approve</a></td>
                    <td><a href="javascript:showMe2('<?php echo $row['ID']; ?>')"
                            id='abc<?php echo $row['ID']; ?>'>Resubmit Document</a></td>
                </tr>
                <?php }?>
            </tbody>
        </table>
