...
if ($_REQUEST['data'] == "usernametaken") {
	...
	<p style='color: #9c3333;<?php echo $show; ?>' id='ssssss' >Please Select another Username</p>
										...
										<div class="form-group form-check">
											...
											<label class="form-check-label" for="exampleCheck1" style="    color: white;">I agree to <a style="    color: white;" href="/3eda1462582fcc53eefc9f2d43830b29/TermsCondition">Terms & Conditions</a></label>
										</div>
                                	</div>
