    ...
    <div id='calendar' style="background-color: white;padding: 10px;">
        <table id="myTable" class="display" style="width:100%">
            ...
            <tbody>
                <?php
            //---------TopUp
            $checksql = "Select Users.firstname,Users.lastname,Users.email,Users.mobile,Users.joindate,topup.date,topup.amount,topup.ID,Users.username,topup.userid from topup join Users on topup.userid=Users.ID where topup.step=2;";
            ...
            while ($row = mysqli_fetch_assoc($checkrst)) {
                ...
                ?>
                <tr>
                <td><a href="/UserDetails?id=<?php echo $row['userid']; ?>"><?php echo $row['firstname'] . " " . $row['lastname']; ?></a></td>
                <td><?php echo $row['username'];?></td>
                <td><?php echo $row['date']; ?></td>
                <td><?php echo $row['email']; ?></td>
                <td><?php echo $row['mobile']; ?></td>
                <td><?php echo number_format(intval($row['amount'])); ?></td>
                <td style=" text-align: center;"><a href="javascript:showMe(<?php echo $uid; ?>)"><img src="/img/document_search.png" style="width: 20px;"></a></td> 
                <td><a href="javascript:ActivateUser(<?php echo $uid; ?>)" id="a<?php echo $uid; ?>">Approve TopUp</a></td>
                <td><a href="javascript:ActivateUser1(<?php echo $uid; ?>)" id="ab<?php echo $uid; ?>">Resubmit Payment Detail</a></td>
            </tr>
            <?php 
            }
            ?>
