...
while ($row = mysqli_fetch_assoc($checkrst)) {
    ...
    ?>
                <tr>
                    <td><a href="/UserDetails?id=<?php echo $row['ID']; ?>"><?php echo $row['firstname'] . " " . $row['lastname']; ?></a></td>
                    ...
                    <td>
                        <a href="javascript:ActivateUser(<?php echo $uid.",".$bool; ?>)" id="a<?php echo $uid; ?>"><?php echo $active1; ?></a>
                    ...
                    <td>
                        <a href="javascript:ActivateUser1(<?php echo $uid; ?>)" id="ab<?php echo $uid; ?>"><?php echo $active2;?></a>
                    </td>
...
{
    $("#a"+id).hide();
    $.post( "/ActUser", {uid: id,bool: bool1 })
        .done(function( data ) {
            alert(data );
        });
}
